-- CollectorsHub: Extend admin helper functions for platform_admin super-access.
...
SECURITY DEFINER
AS $$
  SELECT public.get_admin_class(p_user_id, p_store_id) IN ('platform_admin', 'store_owner', 'store_admin');
$$;
